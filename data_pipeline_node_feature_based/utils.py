#!/usr/bin/env python3
"""
Utility functions for the node-feature-based graph data pipeline.
"""
...
class ProgressLogger:
    """Simple progress logger for tracking processing progress."""
    ...
    def finish(self) -> None:
        print(f"\r{self.desc}: Complete ({self.total}/{self.total})          ")
